...
Based on the results above, we ultimately landed on our model that used backward selection as it had the best adjusted R Squared value, least number of predictors, while also having the best diagnostic plots. Below, we have displayed the formula for our final regression model.
